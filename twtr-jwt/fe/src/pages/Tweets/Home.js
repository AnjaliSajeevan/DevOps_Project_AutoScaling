...
const THome = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      //const res = await fetch(`${process.env.REACT_APP_API_SERVICE_URL}/tweets-results`, {mode: 'cors'});
      const res = await fetch(`http://40.112.134.105/tweets-results`, {mode: 'cors'});
